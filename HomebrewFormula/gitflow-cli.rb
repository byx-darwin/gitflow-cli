class GitflowCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/byx-darwin/gitflow-cli/releases/download/v0.3.0/gitflow-cli-aarch64-apple-darwin.tar.gz"
      sha256 "9efe4aed61efb3f353e9838c9b05fc903066526b1c12c1a87da99c6ba1ee062d"
    else
      url "https://github.com/byx-darwin/gitflow-cli/releases/download/v0.3.0/gitflow-cli-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/byx-darwin/gitflow-cli/releases/download/v0.3.0/gitflow-cli-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "fd9d6c8a340b3c61eb8bc417192ab518db429d5a0bb3e43c24ba435cd5bbc7f9"
    else
      url "https://github.com/byx-darwin/gitflow-cli/releases/download/v0.3.0/gitflow-cli-x86_64-unknown-linux-gnu.tar.gz"
