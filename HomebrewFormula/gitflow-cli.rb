class GitflowCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/byx-darwin/gitflow-cli/releases/download/v0.2.0/gitflow-cli-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/byx-darwin/gitflow-cli/releases/download/v0.2.0/gitflow-cli-aarch64-unknown-linux-gnu.tar.gz"
