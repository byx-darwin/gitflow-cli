...
- 新增 GitLab 自定义域名自动检测（支持 `xyun.git.nyuncloud.com` 等自托管实例） - ([c384a15](https://github.com/byx-darwin/gitflow-cli/commit/c384a159acdbd02fa9d8a0e96a9e4b9e92f5b6f5)) - baoyx
- 新增 HTTPS 远程地址认证信息支持（`user:pass@` 或 `token@`） - ([c384a15](https://github.com/byx-darwin/gitflow-cli/commit/c384a159acdbd02fa9d8a0e96a9e4b9e92f5b6f5)) - baoyx
- 新增 Repo 多级路径解析（支持 `fusion-cdn/bff/admin` 格式） - ([c384a15](https://github.com/byx-darwin/gitflow-cli/commit/c384a159acdbd02fa9d8a0e96a9e4b9e92f5b6f5)) - baoyx

### Bug Fixes

- **(platform)** fix GitLab/GitCode/GitHub multi-platform compatibility (#69) - ([c384a15](https://github.com/byx-darwin/gitflow-cli/commit/c384a159acdbd02fa9d8a0e96a9e4b9e92f5b6f5)) - baoyx
...
- **(platform)** 对齐 hook 路径到 .claude/hooks/ + AgentPlatform 多平台抽象 (#55) - ([c14cb31](https://github.com/byx-darwin/gitflow-cli/commit/c14cb31a56f9e1f0e8ab4f5a4aafcb0a1cba0369)) - baoyx
- **(gitcode)** resolve authentication check bugs and refactor architecture (#54) - ([7bde64d](https://github.com/byx-darwin/gitflow-cli/commit/7bde64de5f68a4b31e4c0e6e8bc2f967e5e41a18)) - baoyx
...
- README 对齐 + 新增 gitflow-workflow-guide (#65) - ([fdb7a43](https://github.com/byx-darwin/gitflow-cli/commit/fdb7a432ef2bcb3e6f52a21e6b5d58b3f2e26e88)) - baoyx

### Chores

- commit leftover plan-issue-59.md (#66) - ([e62d355](https://github.com/byx-darwin/gitflow-cli/commit/e62d355f56caa3f0eb7ba3dfa3c6cbfe7b4f5cb7)) - baoyx
