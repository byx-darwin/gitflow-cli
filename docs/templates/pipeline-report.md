...
Use this template when rendering the output of `gf-pipeline-analyzer`. Fill placeholders with live data from `gf pipeline report`, `pipeline status`, and `pipeline jobs`.
