...
- [gf-workflow 错误分类恢复表实施计划](../docs/superpowers/plans/2026-09-19-gf-workflow-error-classification.md) — Issue #336，2 个 Task：references.md 新增 Phase 3 Execution Error Classification 十类错误表（build/test/lint/merge_conflict/ci/auth/rate_limit/network/issue_unclear/unknown，各配恢复策略与重试上限）→ SKILL.md Phase 3 Step 2 引用该表分类处理失败。`merge_conflict`/`ci` 两类按本仓库排队合并语义定制，未照搬 `smallnest/goal-workflow` 原表。设计见 [../docs/superpowers/specs/2026-09-19-gf-workflow-error-classification-design.md](../docs/superpowers/specs/2026-09-19-gf-workflow-error-classification-design.md)。
